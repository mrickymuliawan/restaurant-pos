	...
	if ($arr['totaldata'] > 0) {
		...
		while ($data=mysqli_fetch_assoc($result)) {
			...
			$arr['table'][]= "<tr>
				...
				<td>$data[diskon]</td>
				<td>
				<button class='btn btn-outline-info btn-sm btn-edit' value='$data[kode_produk]'><i class='fa fa-edit'></i></button>
				<button class='btn btn-outline-danger btn-sm btn-hapus' value='$data[kode_produk]'><i class='fa fa-trash-o'></i></button></td>
			</tr>";
